      ...
      integer, parameter :: SIZE_ENT_DEBUG=NPFT*(16+11 +1) ! 16+11
      ...
      type ent_debug
        ...
        real*8 :: total(NPFT)  ! 17 ! Used as cell summary, Weng, 2021-01-04
        real*8 :: C_lab(NPFT)  ! 18
        real*8 :: C_fol(NPFT)  ! 19
        real*8 :: C_wd(NPFT)   ! 20
        real*8 :: C_froot(NPFT)  ! 21
        real*8 :: P_h(NPFT)   ! 22
        real*8 :: P_dbh(NPFT)  ! 23
